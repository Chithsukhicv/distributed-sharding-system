"""
benchmark_vary_queries_5M.py
============================
Graph 1B — Fixed Data Load: 5 Million Records, Vary Query Count
---------------------------------------------------------------
Query counts : 100, 250, 500, 1000, 2000, 5000
Workers      : 10
Result JSON  : results_vary_queries_5M.json
Output graph : graph1B_vary_queries_5M.png

Usage:
  python benchmark_vary_queries_5M.py --arch single_db
  python benchmark_vary_queries_5M.py --arch hash_sharded
  python benchmark_vary_queries_5M.py --arch random_sharded
  python benchmark_vary_queries_5M.py --arch round_robin
  python benchmark_vary_queries_5M.py --arch directory_based
  python benchmark_vary_queries_5M.py          # run ALL 5
"""
...
RESULTS_FILE = os.path.join(BASE_DIR, "results_vary_queries_5M.json")
OUT_GRAPH    = os.path.join(BASE_DIR, "graph1B_vary_queries_5M.png")
...
def plot(all_data):
    ...
    ax.set_title("Graph 1B — Query Count vs Avg Latency  (5M Records Loaded)",
...
def main():
    ...
    print(f"\n{'='*55}")
    print(f"  📊 BENCHMARK 1B — 5M records, vary query count")
